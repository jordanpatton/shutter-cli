 ...
 *          by completing without throwing an unhandled exception.
 ...
 *          (creating a rejected `Promise`), and it should "succeed" by completing without throwing an unhandled
 *          exception (creating a resolved `Promise`).
